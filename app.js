document.addEventListener('DOMContentLoaded', () => {
    ...
    function processNFCScan(nfcId) {
        ...
        // NFC tag registered - process attendance
    ...
    function startNfcScan() {
        ...
        ndef.scan().then(() => {
            ...
            showScanSuccessAnimation('NFC Ready', 'Tap your NFC card');
            
            ndef.onreadingerror = () => {
                showScanErrorAnimation('NFC read error. Try again.');
    ...
    scanNfcBtn.addEventListener('click', () => {
        if (!currentSessionId) {
            alert('Please start a session first before scanning NFC.');
            return;
        }
        startNfcScan();
    });
